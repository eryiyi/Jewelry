...
import com.lbins.Jewelry.adapter.ViewPagerAdapterGoods;
 ...
 */
public class GongyiXiangjieActivity extends BaseActivity implements View.OnClickListener,OnClickContentItemListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gongyi_xiangjie_activity);
    ...
    private void initViewPager() {
        adapter = new ViewPagerAdapterGoods(GongyiXiangjieActivity.this);
    ...
    private void initDot() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            dot = new ImageView(GongyiXiangjieActivity.this);
