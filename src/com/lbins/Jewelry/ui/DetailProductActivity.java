 ...
 */
public class DetailProductActivity extends BaseActivity implements View.OnClickListener,OnClickContentItemListener{
    ...
    private void initViewPager() {
        adapter = new ViewPagerAdapterGoods(DetailProductActivity.this);
    ...
    private void initDot() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            dot = new ImageView(DetailProductActivity.this);
