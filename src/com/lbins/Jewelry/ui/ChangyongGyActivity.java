 ...
 */
public class ChangyongGyActivity extends BaseActivity implements View.OnClickListener {

    private TextView no_goods;
    private List<String> lists = new ArrayList<String>();
    private ListView lstv ;
    private ChangyonggyAdapter adapter ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.changyonggy_activity);
        initView();
    }
    ...
    private void initView() {
        ...
        lists.add("黄铜");
        lists.add("不锈钢");
        adapter = new ChangyonggyAdapter(lists, ChangyongGyActivity.this);
        ...
        lstv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent detailV = new Intent(ChangyongGyActivity.this, DetailGongyiActivity.class);
