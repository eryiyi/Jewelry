 ...
 * 类的功能、说明写在此处.
 */
public class ChengpinLiebiaoAdapter extends BaseAdapter {
    ...
    public ChengpinLiebiaoAdapter(List<String> findEmps, Context mContext) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.chengpin_item_xml, null);
