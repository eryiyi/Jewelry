 ...
 * 类的功能、说明写在此处.
 */
public class GongyiPicAdapter extends BaseAdapter {
    ...
    public GongyiPicAdapter(List<Integer> findEmps, Context mContext) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.gongyi_pic_item_xml, null);
...
//            imageLoader.displayImage(favour.getCover(), holder.detail_favour_item_cover, UniversityApplication.txOptions, animateFirstListener);
                holder.pic.setImageResource(favour);
